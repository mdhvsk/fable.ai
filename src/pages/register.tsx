    ...
    return (
        <div className="flex h-screen bg-white">
          ...
          <div className="w-1/2 p-12 bg-white">
            ...
            <h1 className="text-5xl font-bold mb-4 text-navy-blue">Get started</h1>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-black hover:bg-navy-blue focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50"
          ...
          <div className="w-1/2 bg-navy-blue relative overflow-hidden m-4 rounded-[20px]">
            <div className="absolute inset-0 bg-navy-blue">
