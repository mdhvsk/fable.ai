...
import { Calendar, Music, Coffee, PenTool, Glasses, Dumbbell, Laptop } from 'lucide-react';

const categories = [
  { name: 'Music', icon: Music },
  { name: 'Food & Drink', icon: Coffee },
  { name: 'Arts & Culture', icon: PenTool },
  { name: 'Parties & Nightlife', icon: Glasses },
  { name: 'Sports & Wellness', icon: Dumbbell },
  { name: 'Networking & Classes', icon: Laptop },
];
